...
<div class="widget-bg">
                            ...
                            <div class="widget-body clearfix">
                                ...
                                <form action="{{route('manager.productGallary.update',$productGallary->id)}}" method="POST">
                                	@csrf()
                                    
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l1">Link</label>
                                        <div class="col-md-9">
                                            <input value="{{$productGallary->link}}" name="link" class="form-control" id="l1" placeholder="Enter text" type="text"> 
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l1">Product id</label>
                                        <div class="col-md-9">
                                            <input value="{{$productGallary->product_id}}" name="product_id" type="text" id="sampleCurrency" name="sampleCurrency" class="form-control mb-0" data-masked-input="$ 999,999,999.99" placeholder="Enter text" maxlength="19"> 
                                        </div>
                                    </div>
