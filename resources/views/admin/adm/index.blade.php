                            ...
                            <div class="widget-body clearfix">
                                ...
                                <ul class="list-unstyled widget-activity">
                                        ...
                                        <div class="media-body"><span class="badge badge-pink py-1 px-2 fs-11 fw-500 mr-1 text-uppercase text-inverse">File</span>
                                            ...
                                            <div class="row">
                                                <div class="col-2 widget-body-image-list">
                                                    <figure>
                                                        <a href="index.html#">
                                                            <img src="{{asset('')}}/assets/demo/widget-activity/1.jpeg">
                                                        </a>
                                                ...
                                                <div class="col-2 widget-body-image-list">
                                                    <figure>
                                                        <a href="index.html#">
                                                            <img src="{{asset('')}}/assets/demo/widget-activity/2.jpeg">
                                                        </a>
                                                ...
                                                <div class="col-2 widget-body-image-list">
                                                    <figure>
                                                        <a href="index.html#">
                                                            <img src="{{asset('')}}/assets/demo/widget-activity/3.jpeg">
                                                        </a>
                                                ...
                                                <div class="col-2 widget-body-image-list">
                                                    <figure>
                                                        <a href="index.html#">
                                                            <img src="{{asset('')}}/assets/demo/widget-activity/4.jpeg">
                                                        </a>
                                                        <figcaption>Red Motor Scooter<small>PNG - 100KB</small>
                                                        </figcaption>
                                                    </figure>
                                    ...
                                    <li class="media">
                                        <div class="d-flex mr-3">
                                            <figure class="user--offline thumb-xs">
                                                <img src="{{asset('')}}/assets/demo/users/user6.jpg" class="rounded-circle" alt="">
                                            </figure>
                                        </div>
                                    ...
                                    <li class="media">
                                        <div class="d-flex mr-3">
                                            <figure class="user--online thumb-xs">
                                                <img src="{{asset('')}}/assets/demo/users/user2.jpg" class="rounded-circle" alt="">
                                            </figure>
                                        </div>
